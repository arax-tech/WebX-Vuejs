...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'admin-campaign': RouteRecordInfo<'admin-campaign', '/admin/campaign', Record<never, never>, Record<never, never>>,
    ...
    'admin-campaign-sms-stats-id': RouteRecordInfo<'admin-campaign-sms-stats-id', '/admin/campaign/sms/stats/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-custom-solution': RouteRecordInfo<'admin-custom-solution', '/admin/custom/solution', Record<never, never>, Record<never, never>>,
    ...
    'admin-invoice': RouteRecordInfo<'admin-invoice', '/admin/invoice', Record<never, never>, Record<never, never>>,
    'admin-invoice-create': RouteRecordInfo<'admin-invoice-create', '/admin/invoice/create', Record<never, never>, Record<never, never>>,
    'admin-invoice-woocommerce': RouteRecordInfo<'admin-invoice-woocommerce', '/admin/invoice/woocommerce', Record<never, never>, Record<never, never>>,
    'admin-lead': RouteRecordInfo<'admin-lead', '/admin/lead', Record<never, never>, Record<never, never>>,
    ...
    'admin-popup-messages': RouteRecordInfo<'admin-popup-messages', '/admin/popup/messages', Record<never, never>, Record<never, never>>,
    ...
    'admin-support': RouteRecordInfo<'admin-support', '/admin/support', Record<never, never>, Record<never, never>>,
    'admin-support-chat-id': RouteRecordInfo<'admin-support-chat-id', '/admin/support/chat/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'client-billing-information': RouteRecordInfo<'client-billing-information', '/client/billing/information', Record<never, never>, Record<never, never>>,
    'client-dashboard': RouteRecordInfo<'client-dashboard', '/client/dashboard', Record<never, never>, Record<never, never>>,
    'client-feedback': RouteRecordInfo<'client-feedback', '/client/feedback', Record<never, never>, Record<never, never>>,
    'client-feedback-create': RouteRecordInfo<'client-feedback-create', '/client/feedback/create', Record<never, never>, Record<never, never>>,
    'client-feedback-edit-id': RouteRecordInfo<'client-feedback-edit-id', '/client/feedback/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'client-invoice': RouteRecordInfo<'client-invoice', '/client/invoice', Record<never, never>, Record<never, never>>,
    'client-password': RouteRecordInfo<'client-password', '/client/password', Record<never, never>, Record<never, never>>,
    ...
    'client-subscription-cancellation-requests': RouteRecordInfo<'client-subscription-cancellation-requests', '/client/subscription/cancellation/requests', Record<never, never>, Record<never, never>>,
    'client-subscription-cancellation-requests-create': RouteRecordInfo<'client-subscription-cancellation-requests-create', '/client/subscription/cancellation/requests/create', Record<never, never>, Record<never, never>>,
    'client-subscription-cancellation-requests-edit-id': RouteRecordInfo<'client-subscription-cancellation-requests-edit-id', '/client/subscription/cancellation/requests/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'client-support': RouteRecordInfo<'client-support', '/client/support', Record<never, never>, Record<never, never>>,
    'client-support-chat-id': RouteRecordInfo<'client-support-chat-id', '/client/support/chat/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'client-support-create': RouteRecordInfo<'client-support-create', '/client/support/create', Record<never, never>, Record<never, never>>,
    'client-support-edit-id': RouteRecordInfo<'client-support-edit-id', '/client/support/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'client-team': RouteRecordInfo<'client-team', '/client/team', Record<never, never>, Record<never, never>>,
    'client-team-create': RouteRecordInfo<'client-team-create', '/client/team/create', Record<never, never>, Record<never, never>>,
    'client-team-edit-id': RouteRecordInfo<'client-team-edit-id', '/client/team/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'invoice-print-id': RouteRecordInfo<'invoice-print-id', '/invoice/print/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
